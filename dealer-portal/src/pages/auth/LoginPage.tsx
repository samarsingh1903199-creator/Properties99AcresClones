...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f9f6] flex items-center justify-center px-4 py-12 relative overflow-hidden">
        ...
        <div className="bg-white rounded-3xl border border-gray-100 p-8"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="relative group">
              <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-300 group-focus-within:text-[#166534] transition-colors" />
              <input
            ...
            <div className="relative group">
              <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-300 group-focus-within:text-[#166534] transition-colors" />
              <input
              ...
              <button type="button" onClick={() => setShowPass(!showPass)}
                className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-300 hover:text-[#166534] transition-colors">
          ...
          <p className="text-center text-sm text-gray-400">
            New dealer?{" "}
            <Link to={ROUTES.REGISTER} className="text-[#166534] font-bold hover:underline underline-offset-4">
              Create an account
            </Link>
          </p>
        </div>
